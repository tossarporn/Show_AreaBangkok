...
FROM `technician_store` INNER JOIN technician_type 
ON technician_store.ref_type = technician_type.id INNER JOIN area_bangkok 
on technician_store.ref_area=area_bangkok.id {$where}";
$json = [];
